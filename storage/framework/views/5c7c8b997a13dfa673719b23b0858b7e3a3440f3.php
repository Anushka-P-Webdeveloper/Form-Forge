<body class="app sidebar-mini">
    ...
    <div id="global-loader">
        <img src="<?php echo e(asset('images/loader.svg')); ?>" class="loader-img" alt="">
    </div>
    <!--Loader-->
    ...
    <div class="page">
        ...
        <div class=" app-sidebar__overlay" data-bs-toggle="sidebar">
            ...
            <aside class="app-sidebar doc-sidebar">
                <a class="header-brand sidemenu-header-brand" href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(asset('your_logo_here.png')); ?>"
...
</body><?php /**PATH /Users/anushka/Desktop/Form-Forge/resources/views/includes/navigation.blade.php ENDPATH**/ ?>